...
class Exercise11_14 {
	...
	static void inputRecord() {
		...
		System.out.println("입력을 마치려면 q 를 입력하세요. 메인 화면으로 돌아갑니다.");  
		...
		while(true) {
			...
			int ban = Integer.parseInt(strArr[1]);
			int no = Integer.parseInt(strArr[2]);
			int kor = Integer.parseInt(strArr[3]);
			int eng = Integer.parseInt(strArr[4]);
			int math = Integer.parseInt(strArr[5]);
